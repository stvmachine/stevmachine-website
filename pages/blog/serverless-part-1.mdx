...
- [Step 1: Let's create a node.js serverless project](#step-1-lets-create-a-nodejs-serverless-project)
- [Step 2: Create a REST resource](#step-2-create-a-rest-resource)
- [Step 3: Saving data to DynamoDB](#step-3-saving-data-to-dynamodb)
- [Step 4: List all the users](#step-4-list-all-the-users)
- [Step 5: Get user details by id](#step-5-get-user-details-by-id)
- [Resources](#resources)
...
We want to create a simple service that allows us to create user and their related information using HTTP events.
