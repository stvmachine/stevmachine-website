...
In my opinnion, this online conference was one of the best that I assisted on this year. The quality of the talks is really good and overall, even I don't really have experience in Rust, gave me the initial push to be part of their community.
...
I really like this talk because among the incoming community it is always difficult to find a suitable project to start working on Rust. The speaker found a good case and presented it in a way that is very simple to understand for developers with experience in objects such as Javascript.
<ReactPlayer url='https://www.youtube.com/watch?v=Z6X7Ada0ugE' />
