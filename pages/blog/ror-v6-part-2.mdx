...
As a continuation of the [Starting with Ruby on Rails v6](/blog/ror-v6-part-1), we are going to keep using `Learn Enough` material.
...
Create a dummy application with users and micro-posts (similar to Twitter).
...
## 2. Let's scaffold some resources!
