...
I used this free template: https://github.com/tbakerx/react-resume-template. But, i decided from the beginning that i want to use some techs on top and remove CSS and jQuery completely. My selected technologies:
